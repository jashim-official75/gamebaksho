...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Game Upload</h4>
                    ...
                    <div class="table-responsive">
                        <table id="demo-foo-addrow" class="table m-t-30 table-hover contact-list" data-page-size="10">
                            ...
                            <tbody>
                                @foreach ($games as $game)
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('assets/frontend/images/uploads/games_img/' . $game->game_banner) }}"
                                                alt="user" width="40" class="img-circle" /> {{ $game->game_name }}
                                        </td>
                                        ...
                                        <td>{{ $game->zip_file_name }}</td>

                                        <td>

                                            <a href="{{ route('games.edit', $game) }}" data-toggle="tooltip"
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="2">
                                        <a href="{{ route('games.create') }}" class="btn btn-info btn-rounded">Add
                                            New
                                            Game</button>
                                    </td>
