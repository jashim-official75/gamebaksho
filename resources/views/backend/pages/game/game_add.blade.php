                        ...
                        <form action="{{ route('games.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-5 col-xs-5">
                                    <div class="card-body">
                                        <label for="exampleInputEmail1" class="mb-4">Game Thumbnail
                                    ...
                                    <div class="card-body">
                                        <label for="game_zip_file" class="mb-4">Game Zip File</label>
                                        <input type="file" id="game_zip_file" class="dropify" data-max-file-size="100M"  name="game_zip_file" accept=".zip,.rar" />
                                    </div>

                                    <div class="card-body">
                                        <label for="exampleInputEmail1" class="mb-4">Game Banner
