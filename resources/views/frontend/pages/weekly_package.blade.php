...
@section('frontend_header')
    <meta property="og:title" content="Enjoy a Wide Range of Online Games on Xoss Games | Weekly package">
    ...
    <meta name="title" content="Play Online Games on Xoss Games - Your Ultimate Gaming Destination | Weekly package" />
    ...
    <title>Enjoy a Wide Range of Online Games on Xoss Games | Weekly package</title>
@endsection
                    ...
                    <div class="tab-pane active" id="tabs-1" role="tabpanel">
                        <div class="plan_card p-5">
                            <section>
                                ...
                                <a href="{{ route('package.prepare', 'weekly') }}"><button class="mt-4">Subscribe
                                        Now</button></a>
                            </section>
                        </div>
                    </div>
