...
@section('frontend_header')
    <meta property="og:title" content="Enjoy a Wide Range of Online Games on Xoss Games | Monthly Packages">
    ...
    <meta name="title" content="Play Online Games on Xoss Games - Your Ultimate Gaming Destination | Monthly Packages" />
    ...
    <title>Enjoy a Wide Range of Online Games on Xoss Games | Monthly Packages</title>
@endsection
                    ...
                    <div class="tab-pane active" id="tabs-1" role="tabpanel">
                        <div class="plan_card p-5">
                            <section>
                                ...
                                <a href="{{ route('package.prepare', 'monthly') }}"><button class="mt-4">Subscribe
                                        Now</button></a>
                            </section>
                        </div>
                    </div>
