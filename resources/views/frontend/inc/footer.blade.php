...
<section class="footer d-none d-sm-block mt-5 py-5">
    <div class="container footer_wrapper">
        <div class="row">
            ...
            <div class="col-3 footer__information col-md-3 col-lg-2">
                ...
                <ul class="list-unstyled">
                    ...
                    @if (Auth::guard('subscriber')->check() && $subscribed)
                        <li class="list-item">
                    ...
                    @if(!$subscribed)
                        <li class="list-item">
                            {{-- <a href="#" data-toggle="modal" data-target="#subscription_pop"><span class="footer_icon"><i class="fa-solid fa-angles-right"></i></span> Subscribe Package</a> --}}
                            <a href="#"><span class="footer_icon"><i class="fa-solid fa-angles-right"></i></span> Subscribe Package</a>
                        </li>
                    @endif

                    <li class="list-item"><a href="{{ route('aboutUs') }}"><span class="footer_icon"><i class="fa-solid fa-angles-right"></i></span> About Us</a></li>
                    <li class="list-item"><a href="{{ route('blogs') }}"><span class="footer_icon"><i class="fa-solid fa-angles-right"></i></span> Blogs</a></li>
                    <li class="list-item"><a href="{{ route('support') }}"><span class="footer_icon"><i class="fa-solid fa-angles-right"></i></span> Support</a></li>
                    <li class="list-itme"> <a href="https://play.google.com/store/apps/details?id=com.naptechlabs.xoss.games" target="_blank"> <img src="{{ asset('assets/frontend/img/get_app.png') }}" alt="xosss games app"></a></li>
                </ul>
            </div>
            ...
            <div class="col-5 col-md-3 footer__information">
                ...
                <ul class="list-unstyled">
                    <li class="list-item"><a href="{{ route('terms.condition') }}"><span class="footer_icon"><i class="fa-solid fa-angles-right"></i></span> Terms and Conditions</a></li>
                    <li class="list-item"><a href="{{ route('privacy') }}"><span class="footer_icon"><i class="fa-solid fa-angles-right"></i></span> Privacy Policy</a></li>
                    <li class="list-item"><a href="{{ route('faq') }}"><span class="footer_icon"><i class="fa-solid fa-angles-right"></i></span> FAQ</a></li>
                    <li class="list-item"><a href="{{ route('contact') }}"><span class="footer_icon"><i class="fa-solid fa-angles-right"></i></span> Contact Us</a></li>
                </ul>
            </div>
        ...
        <div class="row footer__border">
            ...
            <div class="lng__icon">
              <img src="{{ asset('assets/frontend/img/Group 1049.png') }}" alt="" />
            </div>
