...
<body>
    <div class="container">
        <div class="row">
           <iframe src="<?php echo e(asset('AllGames/'. $game->game_file)); ?>" frameborder="0" height="100" width="100"></iframe>
        </div>
    </div>
...
<?php /**PATH /home/customer/www/playtoony.com/public_html/resources/views/frontend/pages/gameplay/mobile.blade.php ENDPATH**/ ?>