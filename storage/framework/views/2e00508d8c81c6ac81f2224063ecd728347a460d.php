...
} elseif ($_instance->childHasBeenRendered('NQX8dNA')) {
    $componentId = $_instance->getRenderedChildComponentId('NQX8dNA');
    $componentTag = $_instance->getRenderedChildComponentTagName('NQX8dNA');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('NQX8dNA');
} else {
    $response = \Livewire\Livewire::mount('frontend.mobile-login');
    $html = $response->html();
    $_instance->logRenderedChild('NQX8dNA', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('frontend.layouts.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/playtoony.com/public_html/resources/views/frontend/pages/mobileLogin.blade.php ENDPATH**/ ?>