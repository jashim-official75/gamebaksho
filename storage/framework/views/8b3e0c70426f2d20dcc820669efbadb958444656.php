                ...
                <?php $__currentLoopData = $games; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $game): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 mb-3 ">
                        <div class="tournament_card">
                            <div class="card_img">
                                <div class="cover_img">
                                    <img src="<?php echo e(asset('uploads/Tournamant/GameImage/' . $game->image)); ?>" alt="">
                            ...
                            <?php if(Auth::guard('subscriber')->user()): ?>
                                <div class="card_body">
                                    <div class="game_title">
                                        <a
                                            href="<?php echo e(route('tournament.game.details', $game->slug)); ?>"><?php echo e($game->game_name); ?></a>
                                    </div>
                                    <div class="play_now-btn">
                                        <a href="<?php echo e(route('tournament.game.details', $game->slug)); ?>"
                            ...
                            <?php else: ?>
                                <div class="card_body">
                                    <div class="game_title">
                                        <a href="<?php echo e(route('user.login')); ?>"><?php echo e($game->game_name); ?></a>
                                    </div>
                                    <div class="play_now-btn">
                                        <a href="<?php echo e(route('user.login')); ?>" class="primary_btn">Join
                                            Now</a>
                                    </div>
...
<?php echo $__env->make('frontend.layouts.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\gamebaksho\resources\views/frontend/tournament/index.blade.php ENDPATH**/ ?>