...
} elseif ($_instance->childHasBeenRendered('oCMWtLg')) {
    $componentId = $_instance->getRenderedChildComponentId('oCMWtLg');
    $componentTag = $_instance->getRenderedChildComponentTagName('oCMWtLg');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('oCMWtLg');
} else {
    $response = \Livewire\Livewire::mount('frontend.mobile-packages');
    $html = $response->html();
    $_instance->logRenderedChild('oCMWtLg', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\gamebaksho\resources\views/frontend/pages/mobilePackages.blade.php ENDPATH**/ ?>