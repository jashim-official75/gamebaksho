...
<head>
  ...
  <meta name="twitter:description" content="Xoss Games | Enjoy a Wide Range of Online Games on Xoss Games">
    ...
    <!-----head ------->
    <?php echo $__env->yieldContent('frontend_header'); ?>
...
//]]></script>
    ...
    <!-- Bootstrap 4 -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/frontend/plugins/Bootstrap/css/bootstrap.min.css')); ?>" async/>
    <!-- Slick Slider  --
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/frontend/plugins/slick-slider/css/slick.css')); ?>" /> 
     <link rel="stylesheet" type="text/css"
        href="<?php echo e(asset('assets/frontend/plugins/slick-slider/css/slick-theme.css')); ?>" />
...
<link href="https://fonts.googleapis.com/css2?family=Luckiest+Guy&display=swap" rel="stylesheet"> -->
 ...
 <link rel="preload" href="<?php echo e(asset('assets/frontend/plugins/slick-slider/css/slick.css')); ?>" as="style" onload="this.onload=null;this.rel='stylesheet'">
   <noscript><link rel="stylesheet"  href="<?php echo e(asset('assets/frontend/plugins/slick-slider/css/slick.css')); ?>"></noscript> 
    <link rel="preload" href="<?php echo e(asset('assets/frontend/plugins/slick-slider/css/slick-theme.css')); ?>" as="style" onload="this.onload=null;this.rel='stylesheet'">
   <noscript><link rel="stylesheet"  href="<?php echo e(asset('assets/frontend/plugins/slick-slider/css/slick-theme.css')); ?>"></noscript> 
 ...
 <!--  <link rel="preload" href="<?php echo e(asset('assets/frontend/css/minified.css')); ?>" as="style" onload="this.onload=null;this.rel='stylesheet'"> -->
   <noscript><link rel="stylesheet"  href="<?php echo e(asset('assets/frontend/css/minified.css')); ?>"></noscript> 
<script>
//<![CDATA[
/*code by anutrickz */
...
<body>
    ...
    <?php if(!$isMobile): ?>
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('frontend.subscription-package')->html();
} elseif ($_instance->childHasBeenRendered('i5F4SsM')) {
    $componentId = $_instance->getRenderedChildComponentId('i5F4SsM');
    $componentTag = $_instance->getRenderedChildComponentTagName('i5F4SsM');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('i5F4SsM');
} else {
    $response = \Livewire\Livewire::mount('frontend.subscription-package');
    $html = $response->html();
    $_instance->logRenderedChild('i5F4SsM', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        ...
        <?php if(Auth::guard('subscriber')->check()): ?>
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('frontend.profile')->html();
} elseif ($_instance->childHasBeenRendered('OA1K6AR')) {
    $componentId = $_instance->getRenderedChildComponentId('OA1K6AR');
    $componentTag = $_instance->getRenderedChildComponentTagName('OA1K6AR');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('OA1K6AR');
} else {
    $response = \Livewire\Livewire::mount('frontend.profile');
    $html = $response->html();
    $_instance->logRenderedChild('OA1K6AR', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php endif; ?>
   ...
   <script src="https://code.jquery.com/jquery-3.5.1.min.js"></script>
    ...
    <script src="<?php echo e(asset('assets/frontend/js/minified.js')); ?>"></script>
...
</html><?php /**PATH /home/customer/www/playtoony.com/public_html/resources/views/frontend/layouts/web.blade.php ENDPATH**/ ?>