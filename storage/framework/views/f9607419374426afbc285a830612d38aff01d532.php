    ...
    <section id="header">
        <div class="container">
            <nav class="navbar navbar-expand-lg navber-fixed">
                <a class="navbar-brand" href="<?php echo e(route('home')); ?>" aria-label="xoss games logo"><img
                        src="<?php echo e(asset('assets/frontend/img/logo.png')); ?>" class="logo__img" width="180" height="45" alt="" /></a>
                ...
                <a class="nav-link text-white custom_btn sm-hide" href="<?php echo e(route('user.login')); ?>" aria-label="user icon">
                    <img
                        src="<?php echo e(asset('assets/frontend/img/user.png')); ?>" alt="" /></a>
...
searchSign.addEventListener("click", function () {
  ...
  <?php /**PATH /home/customer/www/playtoony.com/public_html/resources/views/frontend/inc/header.blade.php ENDPATH**/ ?>